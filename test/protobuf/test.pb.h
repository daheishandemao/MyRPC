...
namespace fixbug {
class GetFriendLisetsRequest;
class GetFriendLisetsRequestDefaultTypeInternal;
extern GetFriendLisetsRequestDefaultTypeInternal _GetFriendLisetsRequest_default_instance_;
class GetFriendLisetsResponse;
class GetFriendLisetsResponseDefaultTypeInternal;
extern GetFriendLisetsResponseDefaultTypeInternal _GetFriendLisetsResponse_default_instance_;
class LoginRequest;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendLisetsRequest* Arena::CreateMaybeMessage<::fixbug::GetFriendLisetsRequest>(Arena*);
template<> ::fixbug::GetFriendLisetsResponse* Arena::CreateMaybeMessage<::fixbug::GetFriendLisetsResponse>(Arena*);
...
class GetFriendLisetsRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendLisetsRequest) */ {
 public:
  inline GetFriendLisetsRequest() : GetFriendLisetsRequest(nullptr) {};
  virtual ~GetFriendLisetsRequest();

  GetFriendLisetsRequest(const GetFriendLisetsRequest& from);
  GetFriendLisetsRequest(GetFriendLisetsRequest&& from) noexcept
    : GetFriendLisetsRequest() {
    *this = ::std::move(from);
  }

  inline GetFriendLisetsRequest& operator=(const GetFriendLisetsRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendLisetsRequest& operator=(GetFriendLisetsRequest&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendLisetsRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendLisetsRequest* internal_default_instance() {
    return reinterpret_cast<const GetFriendLisetsRequest*>(
               &_GetFriendLisetsRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(GetFriendLisetsRequest& a, GetFriendLisetsRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendLisetsRequest* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetFriendLisetsRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetFriendLisetsRequest* New() const final {
    return CreateMaybeMessage<GetFriendLisetsRequest>(nullptr);
  }

  GetFriendLisetsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendLisetsRequest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendLisetsRequest& from);
  void MergeFrom(const GetFriendLisetsRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendLisetsRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendLisetsRequest";
  }
  protected:
  explicit GetFriendLisetsRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendLisetsRequest)
 private:
  class _Internal;
...
class GetFriendLisetsResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendLisetsResponse) */ {
 public:
  inline GetFriendLisetsResponse() : GetFriendLisetsResponse(nullptr) {};
  virtual ~GetFriendLisetsResponse();

  GetFriendLisetsResponse(const GetFriendLisetsResponse& from);
  GetFriendLisetsResponse(GetFriendLisetsResponse&& from) noexcept
    : GetFriendLisetsResponse() {
    *this = ::std::move(from);
  }

  inline GetFriendLisetsResponse& operator=(const GetFriendLisetsResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendLisetsResponse& operator=(GetFriendLisetsResponse&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendLisetsResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendLisetsResponse* internal_default_instance() {
    return reinterpret_cast<const GetFriendLisetsResponse*>(
               &_GetFriendLisetsResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendLisetsResponse& a, GetFriendLisetsResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendLisetsResponse* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetFriendLisetsResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetFriendLisetsResponse* New() const final {
    return CreateMaybeMessage<GetFriendLisetsResponse>(nullptr);
  }

  GetFriendLisetsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendLisetsResponse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendLisetsResponse& from);
  void MergeFrom(const GetFriendLisetsResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendLisetsResponse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendLisetsResponse";
  }
  protected:
  explicit GetFriendLisetsResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendLisetsResponse)
 private:
  class _Internal;
...
class UserServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void GetFriendLisets(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class UserServiceRpc_Stub : public UserServiceRpc {//服务消费者
 public:
  ...
  void Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::fixbug::LoginResponse* response,
                       ::google::protobuf::Closure* done);
  void GetFriendLisets(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::fixbug::GetFriendLisetsRequest* request,
                       ::fixbug::GetFriendLisetsResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
// uint32 userid = 1;
inline void GetFriendLisetsRequest::clear_userid() {
  userid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendLisetsRequest::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendLisetsRequest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendLisetsRequest.userid)
  return _internal_userid();
}
inline void GetFriendLisetsRequest::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriendLisetsRequest::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendLisetsRequest.userid)
}
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendLisetsResponse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendLisetsResponse::has_result() const {
  return _internal_has_result();
}
inline void GetFriendLisetsResponse::clear_result() {
  if (GetArena() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendLisetsResponse::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendLisetsResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendLisetsResponse.result)
  return _internal_result();
}
inline void GetFriendLisetsResponse::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendLisetsResponse.result)
}
inline ::fixbug::ResultCode* GetFriendLisetsResponse::release_result() {
  auto temp = unsafe_arena_release_result();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::fixbug::ResultCode* GetFriendLisetsResponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendLisetsResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendLisetsResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendLisetsResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendLisetsResponse.result)
  return _internal_mutable_result();
}
inline void GetFriendLisetsResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendLisetsResponse.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetFriendLisetsResponse::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriendLisetsResponse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendLisetsResponse::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriendLisetsResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendLisetsResponse.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendLisetsResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendLisetsResponse.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriendLisetsResponse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendLisetsResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendLisetsResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendLisetsResponse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriendLisetsResponse::add_friend_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendLisetsResponse.friend_list)
  return _internal_add_friend_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendLisetsResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendLisetsResponse.friend_list)
  return friend_list_;
}
