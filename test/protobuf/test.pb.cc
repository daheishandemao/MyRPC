...
class GetFriendLisetsRequestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendLisetsRequest> _instance;
} _GetFriendLisetsRequest_default_instance_;
class UserDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<User> _instance;
} _User_default_instance_;
class GetFriendLisetsResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendLisetsResponse> _instance;
} _GetFriendLisetsResponse_default_instance_;
}  // namespace fixbug
static void InitDefaultsscc_info_GetFriendLisetsRequest_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendLisetsRequest_default_instance_;
    new (ptr) ::fixbug::GetFriendLisetsRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendLisetsRequest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendLisetsRequest_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendLisetsRequest_test_2eproto}, {}};

static void InitDefaultsscc_info_GetFriendLisetsResponse_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendLisetsResponse_default_instance_;
    new (ptr) ::fixbug::GetFriendLisetsResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendLisetsResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendLisetsResponse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendLisetsResponse_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendLisetsRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendLisetsRequest, userid_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendLisetsResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendLisetsResponse, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendLisetsResponse, friend_list_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::ResultCode)},
  { 7, -1, sizeof(::fixbug::LoginRequest)},
  { 14, -1, sizeof(::fixbug::LoginResponse)},
  { 21, -1, sizeof(::fixbug::GetFriendLisetsRequest)},
  { 27, -1, sizeof(::fixbug::User)},
  { 35, -1, sizeof(::fixbug::GetFriendLisetsResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendLisetsRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_User_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendLisetsResponse_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  &scc_info_GetFriendLisetsRequest_test_2eproto.base,
  &scc_info_GetFriendLisetsResponse_test_2eproto.base,
...
void GetFriendLisetsRequest::InitAsDefaultInstance() {
}
class GetFriendLisetsRequest::_Internal {
 public:
};

GetFriendLisetsRequest::GetFriendLisetsRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendLisetsRequest)
}
GetFriendLisetsRequest::GetFriendLisetsRequest(const GetFriendLisetsRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  userid_ = from.userid_;
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendLisetsRequest)
}

void GetFriendLisetsRequest::SharedCtor() {
  userid_ = 0u;
}

GetFriendLisetsRequest::~GetFriendLisetsRequest() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendLisetsRequest)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void GetFriendLisetsRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void GetFriendLisetsRequest::ArenaDtor(void* object) {
  GetFriendLisetsRequest* _this = reinterpret_cast< GetFriendLisetsRequest* >(object);
  (void)_this;
}
void GetFriendLisetsRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetFriendLisetsRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendLisetsRequest& GetFriendLisetsRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendLisetsRequest_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendLisetsRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendLisetsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendLisetsRequest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendLisetsRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendLisetsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendLisetsRequest)
  return target;
}

size_t GetFriendLisetsRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendLisetsRequest)
  size_t total_size = 0;
...
void GetFriendLisetsRequest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendLisetsRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendLisetsRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendLisetsRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendLisetsRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendLisetsRequest)
    MergeFrom(*source);
  }
}

void GetFriendLisetsRequest::MergeFrom(const GetFriendLisetsRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendLisetsRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendLisetsRequest::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendLisetsRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendLisetsRequest::CopyFrom(const GetFriendLisetsRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendLisetsRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendLisetsRequest::IsInitialized() const {
  return true;
}

void GetFriendLisetsRequest::InternalSwap(GetFriendLisetsRequest* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  swap(userid_, other->userid_);
}

::PROTOBUF_NAMESPACE_ID::Metadata GetFriendLisetsRequest::GetMetadata() const {
  return GetMetadataStatic();
}
...
void GetFriendLisetsResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendLisetsResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendLisetsResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendLisetsResponse* msg);
};

const ::fixbug::ResultCode&
GetFriendLisetsResponse::_Internal::result(const GetFriendLisetsResponse* msg) {
  return *msg->result_;
}
GetFriendLisetsResponse::GetFriendLisetsResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena),
  friend_list_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendLisetsResponse)
}
GetFriendLisetsResponse::GetFriendLisetsResponse(const GetFriendLisetsResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendLisetsResponse)
}

void GetFriendLisetsResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendLisetsResponse_test_2eproto.base);
  result_ = nullptr;
}

GetFriendLisetsResponse::~GetFriendLisetsResponse() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendLisetsResponse)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void GetFriendLisetsResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  if (this != internal_default_instance()) delete result_;
}

void GetFriendLisetsResponse::ArenaDtor(void* object) {
  GetFriendLisetsResponse* _this = reinterpret_cast< GetFriendLisetsResponse* >(object);
  (void)_this;
}
void GetFriendLisetsResponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetFriendLisetsResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendLisetsResponse& GetFriendLisetsResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendLisetsResponse_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendLisetsResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendLisetsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendLisetsResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendLisetsResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendLisetsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendLisetsResponse)
  return target;
}

size_t GetFriendLisetsResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendLisetsResponse)
  size_t total_size = 0;
...
void GetFriendLisetsResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendLisetsResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendLisetsResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendLisetsResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendLisetsResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendLisetsResponse)
    MergeFrom(*source);
  }
}

void GetFriendLisetsResponse::MergeFrom(const GetFriendLisetsResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendLisetsResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendLisetsResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendLisetsResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendLisetsResponse::CopyFrom(const GetFriendLisetsResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendLisetsResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendLisetsResponse::IsInitialized() const {
  return true;
}

void GetFriendLisetsResponse::InternalSwap(GetFriendLisetsResponse* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendLisetsResponse::GetMetadata() const {
  return GetMetadataStatic();
}
...
void UserServiceRpc::GetFriendLisets(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendLisetsRequest*,
                         ::fixbug::GetFriendLisetsResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GetFriendLisets() not implemented.");
  done->Run();
}
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      ...
      break;
    case 1:
      GetFriendLisets(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendLisetsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendLisetsResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendLisetsRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendLisetsResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRpc_Stub::GetFriendLisets(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              const ::fixbug::GetFriendLisetsRequest* request,
                              ::fixbug::GetFriendLisetsResponse* response,
                              ::google::protobuf::Closure* done) {
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendLisetsRequest* Arena::CreateMaybeMessage< ::fixbug::GetFriendLisetsRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendLisetsRequest >(arena);
}
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendLisetsResponse* Arena::CreateMaybeMessage< ::fixbug::GetFriendLisetsResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendLisetsResponse >(arena);
}
